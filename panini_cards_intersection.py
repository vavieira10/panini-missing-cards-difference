...
def cards_intersection(missing: str, third_party_repeated: str, separator:str = ', ') -> str:
    ...
    return separator.join(missing_in_third_party_repeated)


def assemble_repeated_dict(repeated_list: list[str]) -> dict:
    return { r.replace(' ', '') : True for r in repeated_list }
